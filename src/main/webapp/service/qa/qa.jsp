							...
							<div class="qa-table">
								<table>
									<tbody>
										...
										<tr>
											<th>작성자</th>
											<td><input type="text" id="guest_name" name="guest_name"
											...
											<td>
												<div class="form-group">
													<label for="password"></label> <input type="password"
														id="guest_password" name="guest_password" required
										...
										<tr>
											...
											<td>
												<div class="table-email">
													<input type="text" name="email_id"> <select
										...
										<tr>
											...
											<td>
												<div class="qa-cha">
													<img src="/assets/img/service/20251224_172731.png"
														alt="자동방지">
													<div class="cha-txt">
														<p>
															보이는 순서대로 <br>숫자 및 문자를 모두 입력해주세요
														</p>
														<input type="text">
														<button>이미지 새로고침</button>
													</div>
