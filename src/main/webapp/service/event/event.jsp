    ...
    <main>
        <div id="event">
            <div class="location-wrap">
                <div class="location-con"><a href="#">HOME</a>>event</div>
            </div> <!--//. location-wrap  -->
                    ...
                    <div class="event-tit">
                        ...
                        <div class="event-category">
                            <ul>
                                ...
                                <li><button class="tab-btn" data-tab="ongoing">진행중 이벤트</button></li>
                                <li><button class="tab-btn" data-tab="ended">종료된 이벤트</button></li>
                            </ul>
                        </div>
                    </div>
        ...
        <c:forEach var="e" items="${eventList}">
            <li>
                <div class="event-card" data-tab="${e.tab}">
                    <div class="event-img">
                        <a href="${pageContext.request.contextPath}/service/event/event_view.jsp?eventId=${e.id}">
                            <img src="${pageContext.request.contextPath}/assets/img/service/${e.img}" alt="${e.alt}" />
                        </a>
                    </div>
              ...
              <li><a href="#">4</a></li> -->
                        ...
                        </div><!-- //.service-pagenation -->
                    </div>
                </div>
            </div>
            <script src="${ctx}/assets/js/service/event_card_data.js"></script>
            <script src="${ctx}/assets/js/service/event_card.js"></script>
